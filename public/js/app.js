...
function placeOrder(formObject) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/orders', formObject).then(function (res) {
    new noty__WEBPACK_IMPORTED_MODULE_1___default.a({
      ...
      progressBar: false
    }).show(); //here we have recv notification and here we can redirect to customer pages
...
function updateCart(pizzas) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/update-cart', pizzas).then(function (res) {
    console.log(res);
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var pizza = JSON.parse(btn.dataset.pizzas); //calling the json to see the object of the pizzas
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return Object(_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__["loadStripe"])('pk_test_51IbAY4SEfgyVBzoTTz89LHwThW7ReGOOlwQuwKWqb7JkYhrEx6ZugTgqSuWzt4yTTK2NjtmN7hveLAOxDjSAiEYs00FJuwD0mx');
...
__webpack_require__(/*! S:\Realtime-pizza\pizza\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! S:\Realtime-pizza\pizza\resources\scss\app.scss */"./resources/scss/app.scss");
